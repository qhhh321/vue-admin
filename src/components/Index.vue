    ...
    <div class="index-vue">
        ...
        <aside :class="asideClassName">
            ...
            <div class="logo-c">
                ...
                <span v-show="isShowAsideTitle">{{ $t('title') }}</span>
            </div>
            <!-- 菜单栏 -->
        ...
        <section class="sec-right">
            ...
            <div class="top-c">
                <header>
                    ...
                    <div class="h-right">
                        <!-- 语言切换 -->
                        <div class="lang-c" @click="changLang" title="英文/中文">
                            <div>英文/中文</div>
                        </div>
                        <!-- 消息 -->
...
.active {
    border-bottom: 2px solid #38465f;
}
.active a {
    color: #38465f;
}
...
.ivu-menu-dark {
 ...
 /* .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title[data-v-82b7485c][data-v-82b7485c], .ivu-menu-dark.ivu-menu-vertical .ivu-menu-item-active[data-v-82b7485c][data-v-82b7485c]:not(.ivu-menu-submenu), .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title-active[data-v-82b7485c]:not(.ivu-menu-submenu).ivu-menu-dark.ivu-menu-vertical .ivu-menu-item[data-v-82b7485c], .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title[data-v-82b7485c], .ivu-menu-dark.ivu-menu-vertical .ivu-menu-item-active[data-v-82b7485c]:not(.ivu-menu-submenu), .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title-active[data-v-82b7485c]:not(.ivu-menu-submenu),.ivu-menu-dark.ivu-menu-vertical .ivu-menu-item-active:not(.ivu-menu-submenu), .ivu-menu-dark.ivu-menu-vertical .ivu-menu-item-active:not(.ivu-menu-submenu):hover, .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title-active:not(.ivu-menu-submenu), .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title-active:not(.ivu-menu-submenu):hover,.ivu-menu-dark.ivu-menu-vertical .ivu-menu-item-active[data-v-82b7485c]:not(.ivu-menu-submenu), .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title-active[data-v-82b7485c]:not(.ivu-menu-submenu){
    background: #fff;
}

    .ivu-menu-dark.ivu-menu-vertical .ivu-menu-item-active:not(.ivu-menu-submenu), .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title-active:not(.ivu-menu-submenu).ivu-menu-dark.ivu-menu-vertical .ivu-menu-item, .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title,.ivu-menu-dark.ivu-menu-vertical .ivu-menu-item[data-v-82b7485c], .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title[data-v-82b7485c], .ivu-menu-dark.ivu-menu-vertical .ivu-menu-item-active[data-v-82b7485c]:not(.ivu-menu-submenu), .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title-active[data-v-82b7485c]:not(.ivu-menu-submenu).ivu-menu-dark.ivu-menu-vertical .ivu-menu-item, .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title,.ivu-menu-dark.ivu-menu-vertical .ivu-menu-item-active:not(.ivu-menu-submenu), .ivu-menu-dark.ivu-menu-vertical .ivu-menu-submenu-title-active:not(.ivu-menu-submenu){
    background: #000;
    } */
